/* arch/arm/mach-msm/board-u8800.c
...
static const unsigned int u8800_keymap[] = {
	KEY(0, 0, KEY_VOLUMEUP),
	KEY(0, 1, KEY_VOLUMEDOWN),
};

static struct matrix_keymap_data u8800_keymap_data = {
	.keymap_size	= ARRAY_SIZE(u8800_keymap),
	.keymap		= u8800_keymap,
};

static struct pm8xxx_keypad_platform_data u8800_keypad_data = {
	.input_name		= "u8800-keypad",
	.input_phys_device	= "u8800-keypad/input0",
	.num_rows		= 5,
	.num_cols		= 5,
...
static int __init buses_init(void)
{
	...
	pm8058_7x30_data.keypad_pdata = &u8800_keypad_data;
